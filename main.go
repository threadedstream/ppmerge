...
func main() {
	...
	//fmt.Println(merger.mergedProfile.Functions)
	//
	//bufferMerged := bytes.NewBuffer(nil)
	//mergedProfile, err := profile.Merge(profiles)
	//if err != nil {
	//	log.Fatal(err)
	//}
	//
	//if err = mergedProfile.Write(bufferMerged); err != nil {
	//	log.Fatal(err)
	//}

	//println(bufferMerged.Len())

	//fileToWrite, err := os.OpenFile(dir+"resultprof", os.O_RDWR|os.O_TRUNC, os.ModePerm)
	//if err != nil {
	//	log.Fatal(err)
	//}
	//var prof *profile.Profile
	//
	//if prof, err = profile.Parse(fileToWrite); err != nil {
	//	log.Fatal(err)
	//}
	//
	//println(prof)
...
//func (pw *profileMerger) unpackFunctions(idx uint64) ([]*profile.Function, error) {
//	if idx > uint64(len(pw.mergedProfile.NumFunctions)) {
//		return nil, errors.New("index out of range")
//	}
//	functionsLen := pw.mergedProfile.NumFunctions[idx]
//	functions := make([]*profile.Function, 0, functionsLen)
//
//	var offset uint64
//	for i := uint64(0); i < idx; i++ {
//		offset += pw.mergedProfile.NumFunctions[i] * 5
//	}
//
//	limit := offset + (functionsLen * 5)
//
//	for offset < limit {
//		functions = append(functions, pw.unpackFunction(offset))
//		offset += 5
//	}
//
